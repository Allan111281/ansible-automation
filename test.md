...
❌ Ikke synlige passwords i Git ✔ Krypterede credentials i repo
...
👉 Hver bruger har sin egen Vault password file 👉 Der deles ikke én fælles fil mellem brugere
...
ansible.cfg læses
vault_password_file findes
vault.yml dekrypteres
credentials indlæses
connection til Windows servere
playbook køres
5. Regler (meget vigtigt)
Må i Git
✔ playbooks ✔ inventory ✔ ansible.cfg ✔ krypteret vault.yml

Må IKKE i Git
❌ .vault_pass ❌ passwords i clear text ❌ credentials
